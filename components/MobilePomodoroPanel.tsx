...
const MobilePomodoroPanel: React.FC<MobilePomodoroPanelProps> = (props) => {
  ...
  return (
    <>
      <div 
        className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[99999] animate-fade-in" 
        onClick={onClose}
      ></div>
      <div 
        className="fixed bottom-0 left-0 right-0 max-h-[90vh] bg-secondary-lighter dark:bg-gray-800 rounded-t-2xl shadow-2xl flex flex-col z-[100000] animate-slide-up"
