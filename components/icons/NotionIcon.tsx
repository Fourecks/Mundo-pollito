...
const NotionIcon: React.FC<NotionIconProps> = ({ className = 'w-4 h-4', size }) => {
  ...
  return (
    <span className={`inline-flex items-center justify-center flex-shrink-0 ${className}`} style={style}>
      <svg viewBox="0 0 100 100" fill="currentColor" className="w-full h-full text-black dark:text-white drop-shadow-sm">
