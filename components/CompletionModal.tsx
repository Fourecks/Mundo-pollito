...
const CompletionModal: React.FC<CompletionModalProps> = ({ isOpen, onClose, quote }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-gradient-to-br from-secondary-lighter to-primary-light/30 dark:from-gray-800 dark:to-gray-900 rounded-3xl shadow-2xl p-8 pt-10 text-center relative max-w-sm mx-auto transform transition-all duration-300 scale-95 opacity-0 animate-pop-in border-4 border-white dark:border-gray-700 max-h-[90vh] overflow-y-auto"
