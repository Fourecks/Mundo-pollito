...
const MobilePomodoroWidget: React.FC<MobilePomodoroWidgetProps> = ({ timeLeft, isActive, mode, onToggle, onOpenModal, onSwitchMode, onReset }) => {
  return (
    <div className="w-full p-4 flex items-center justify-between relative cursor-pointer bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-lg" onClick={onOpenModal}>
