...
const CommandPalette: React.FC<CommandPaletteProps> = ({ isOpen, onClose, actions }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[110000] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md transition-opacity duration-200" onClick={onClose}>
      <div 
