    ...
    <div className="px-3 py-1.5 border-b border-zinc-200 dark:border-zinc-800/80 flex flex-wrap items-center gap-1 bg-zinc-50/90 dark:bg-zinc-900/90 text-zinc-700 dark:text-zinc-200 select-none text-xs relative z-40">
      ...
      {typeof document !== 'undefined' && showTableModal && createPortal(
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fade-in">
          <div className="bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-zinc-800 rounded-3xl shadow-2xl p-6 w-full max-w-xs text-left">
      ...
      {typeof document !== 'undefined' && showLinkModal && createPortal(
        ...
        >
          <div 
            className="bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-zinc-800 rounded-3xl shadow-2xl p-6 w-full max-w-sm text-left max-h-[90vh] overflow-y-auto"
            onClick={e => e.stopPropagation()}
          >
            <div className="flex items-center justify-between mb-3">
              <h4 className="text-sm font-semibold text-zinc-900 dark:text-zinc-100 flex items-center gap-2">
