...
const NotificationsPanel: React.FC<NotificationsPanelProps> = (props) => {
    ...
    return (
        <div className="fixed inset-0 z-[90000] flex justify-end bg-black/20 backdrop-blur-sm animate-fade-in" onClick={onClose}>
            <div 
                className="w-full max-w-sm h-full bg-white dark:bg-[#0a0a0a] border-l border-gray-200 dark:border-gray-800 flex flex-col transform transition-transform duration-300 animate-slide-in-right overflow-hidden shadow-xl"
